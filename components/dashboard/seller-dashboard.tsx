    ...
    getData("/user/dashboard/stats")
      .then((res) => {
        setStats({
          ...
          approvedDomains: res.data.approved_domains,
          totalEarnings: res.data.total_earnings,
          myDomains: res.data.domains || [],
        });
        setLoading(false);
      })
      .catch((err) => {
          ...
          <div className="space-y-4">
            {stats.myDomains.length === 0 ? (
              <div className="text-center py-8">
                ...
                <Button
                  asChild
                  className="mt-4 bg-[#00ff9d] text-black hover:bg-[#00e68a]"
                >
                  <Link href="/dashboard/submit-domain">
