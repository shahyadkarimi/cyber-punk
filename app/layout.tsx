...
export const metadata: Metadata = {
  ...
  keywords: "web shells, security tools, exploits, cybersecurity, penetration testing, ethical hacking, TRXSecurity",
    generator: 'v0.dev'
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${jetbrainsMono.className} bg-[#0d0d0f] text-gray-200 min-h-screen flex flex-col`}>
